                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label>Phone *</label>
                                <input type="text" name="phone" pattern="[0-9]{10}" value="<?php echo htmlspecialchars($edit_student['phone']); ?>" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="year" required>
                                ...
                                <option value="1" <?php echo $edit_student['year'] == 'L3' ? 'selected' : ''; ?>>Level 3</option>
                                <option value="2" <?php echo $edit_student['year'] == 'L4' ? 'selected' : ''; ?>>Level 4</option>
                                <option value="3" <?php echo $edit_student['year'] == 'L5' ? 'selected' : ''; ?>>Level 5</option>
                            </select>
                        </div>
